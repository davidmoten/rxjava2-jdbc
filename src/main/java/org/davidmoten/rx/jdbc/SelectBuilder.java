...
public class SelectBuilder {
    ...
    // }
    //
    // static <T> Flowable<T> autoMap(Class<T> cls, QueryBuilder builder,
    // Func1<ResultSet, ? extends ResultSet> resultSetTransform) {
    ...
    // * @return
    // */
    // public <T1, T2, T3> Observable<Tuple3<T1, T2, T3>> getAs(Class<T1> cls1,
    // Class<T2> cls2,
    // Class<T3> cls3) {
    ...
    // * @return
    // */
    // public <T1, T2, T3, T4> Observable<Tuple4<T1, T2, T3, T4>>
    // getAs(Class<T1> cls1,
    ...
    // * @return
    // */
    // public <T1, T2, T3, T4, T5> Observable<Tuple5<T1, T2, T3, T4, T5>>
    // getAs(Class<T1> cls1,
    ...
    // * @return
    // */
    // public <T1, T2, T3, T4, T5, T6> Observable<Tuple6<T1, T2, T3, T4, T5,
    // T6>> getAs(
    // Class<T1> cls1, Class<T2> cls2, Class<T3> cls3, Class<T4> cls4, Class<T5>
    // cls5,
    // Class<T6> cls6) {
    ...
    // * @return
    // */
    // public <T1, T2, T3, T4, T5, T6, T7> Observable<Tuple7<T1, T2, T3, T4, T5,
    // T6, T7>> getAs(
    // Class<T1> cls1, Class<T2> cls2, Class<T3> cls3, Class<T4> cls4, Class<T5>
    // cls5,
