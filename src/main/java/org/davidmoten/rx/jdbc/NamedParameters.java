...
public enum NamedParameters {
    ;
    
    public static SqlWithNames parse(String namedSql) {
    ...
    public static class SqlWithNames {
        private final String sql;
        private final List<String> names;

        public SqlWithNames(String sql, List<String> names) {
            this.sql = sql;
            this.names = names;
        }
